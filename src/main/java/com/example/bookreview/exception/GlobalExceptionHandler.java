...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * XSS/로그 인젝션 방지: - CR/LF/TAB 등 제어문자를 공백으로 치환 - 길이 제한
     */
    ...
    /**
     * 응답에 문자열을 포함해야 할 경우: - HTML escape를 적용해, 템플릿/프론트에서 실수로 innerHTML로 렌더링하더라도 안전하게 만든다.
     */
    ...
    /**
     * 스택트레이스 출력은 최소화하되, throwable.getMessage()는 포함하지 않는다. (사용자 입력 반사/XSS/민감정보 노출 가능성 차단)
     */
